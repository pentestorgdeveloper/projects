...
(function(root, factory) {
	...
	$.extend(Selectize.prototype, {
		...
		setup: function() {
			...
			$control.on({
				...
				dblclick  : function(e) { return self.onDblClick.apply(self, arguments) },
			});
	...
	Selectize.define('editable_tag', function (options) {
		var self = this;
		...
		this.onDblClick = (function(e) {
			var original = self.onDblClick;
			return function(e) {
				var index, option;
					//debugger
					//index = this.caretPos - 1;
					index = $(this.$activeItems).index()
					if (index >= 0 && index < this.items.length) {
						option = this.options[this.items[index]];
						if (this.deleteSelection(e)) {
							this.setTextboxValue(options.text.apply(this, [option]));
