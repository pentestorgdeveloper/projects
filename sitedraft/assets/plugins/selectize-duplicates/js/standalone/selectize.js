...
(function(root, factory) {
  ...
  //       var original = self.setup;
  //       return function () {
  //           var res = original.apply(this, _arguments);
	//
  //           self.$control.on('dblclick', function (event) {
  //               var value = $(event.target).data('value');
  //               var itemIndex = self.items.indexOf(value);
  //               if (itemIndex >= 0 && itemIndex < self.items.length) {
  //                   var option = self.options[self.items[itemIndex]];
  ...
  //       var original = self.setTextboxValue;
  //       return function () {
  //           if (!self._restoringUpdateItem) {
  //               self._restoringUpdateItem = true;
  //               self._createItemWhenInputBlur();
  //               self._restoringUpdateItem = false;
  //           }
  //           return original.apply(this, _arguments[0]);
  //       };
  //   }();
	// });
